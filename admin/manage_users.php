                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = mysqli_query($conn, "SELECT * FROM `duser`");
                                                        $num = 1;
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn text-white disabled <?php   ?>" style="background:<?php if ($row['status']== 'pending') {echo 'red';}elseif($row['status'] == 'Confirmed'){echo 'green';} ?>"><?php echo $row['status']; ?></div>
                                                                    </td>
