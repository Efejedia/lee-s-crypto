                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = mysqli_query($conn, "SELECT * FROM `ddeposite`");
                                                        $num = 1;
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn text-white disabled <?php   ?>" style="background:<?php if ($row['status']== 'Pending') {echo 'red';}else{echo 'green';} ?>"><?php echo $row['status']; ?></div>
                                                                    </td>
                                                                    

                                                                    <td>
                                                                        <a href="deposite-detail?userid=<?php echo $row['unique_id']; ?>&deposite=<?php echo $deposite_id;  ?>&amount=<?php echo $amount ?>" class="btn btn-warning">View</a>

                                                                         <!-- <a href="subscribers_logic?state=delete&uid=<?php echo $userid ?> " class="btn btn-danger btn-sm">Delete</a> -->
                                                                         
                                                                         <input type="hidden" name="userid" value="<?php echo $row['unique_id'] ?>" <?php echo $userid ?> >
