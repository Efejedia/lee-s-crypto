    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
                ...
                <?php
                // $userid = $_GET['userid'];
                $sql = mysqli_query($conn, "SELECT * FROM ddeposite  where unique_id = '$id'");
                        ...
                        <div class="col-md-4 m-auto col-lg-10">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <p class="card-text py-4">🍿 Get ready for a Netflix marathon! Subscription activated. Enjoy non-stop entertainment. 🎉📺</p>
