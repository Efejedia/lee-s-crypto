    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
                ...
                <?php
                // $userid = $_GET['userid'];
                $sql = mysqli_query($conn, "SELECT * FROM invest where userid = '$id' ORDER BY id DESC");
                ...
                ?>
                        <div class="col-md-4 m-auto col-lg-10">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h4 class="card-title text-success py-5">Payment Successful!!!!</h4>
                                    <p class="card-text py-4">Dear investor you have successfully investen on <?php echo $row['plan'] ?> enjoy your investment. 🎉📺</p>
                                    <div class="table-responsive ">
                                        <table class="table table-hover no-wrap py-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Plan</th>
                                                    <td><?php echo ucfirst($row['plan']); ?></td>
                                                </tr>

                                                <tr>
                                                    <th>Maximul amount</th>
                                                    <td><?php echo $row['max'];   ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Manimul amount</th>
                                                ...
                                                <tr>
                                                    <th>Return</th>
                                                    <td><?php echo formatNaira($row['total_amount']); ?></td>
                                                </tr>
                                    ...
                                    <a href="dashboard" class="btn btn-primary">Go Dashboard</a>
                                </div>
                            </div>
                        </div>
                <?php
